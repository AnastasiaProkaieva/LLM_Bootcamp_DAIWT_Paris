...
def load_model(run_mode: str, dbfs_cache_dir: str, serving_uri :str='llama_2_13b', model_name:str = "llama_2_gpu"):
    ...
    if run_mode == 'cpu':
      ...
      return pipe
        ...
        #model_uri = "https://e2-dogfood.staging.cloud.databricks.com/serving-endpoints/hf_inference_bootcamp_endpoint_llama2_7b_completions/invocations"
...
#         # send request
#         try:
#             #requests.request(method='POST', headers=headers, url=url, data=data_json)
...
#                 f"Error raised by inference API: {e}.\nResponse: {response.text}"
#             )
#         print('HERE BEFORE THE PARSED RESPONSE')
#         return parsed_response
